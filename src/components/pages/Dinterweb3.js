...
function Dinterweb3() {
    return (
        <>
            <h1 className='text-6xl text-center m-7'>Pagina 3</h1>
            <div class="">
                <div className=''>
                    <h2 className='text-4xl text-center mt-14 m-auto'>Prueba ir a la pagina 1 o 2 todo carga al instante </h2>
                ...
                <Link to='/Dinterweb2'>
                    <button class="px-10 py-3 mt-4 text-base text-white bg-red-500  rounded-3xl" >Ir a pagina 2</button>
                </Link>
                </div>
